...
class GAN(object):
	...
	def __init__(self):
		...
		self.g_W1 = np.random.randn(150,300).astype(np.float32) * np.sqrt(2.0/(150))
		self.g_b1 = np.zeros(300).astype(np.float32)
		
		self.g_W2 = np.random.randn(300,28*28).astype(np.float32) * np.sqrt(2.0/(300))
